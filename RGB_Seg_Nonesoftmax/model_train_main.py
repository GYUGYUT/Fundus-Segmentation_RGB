...
os.environ["CUDA_VISIBLE_DEVICES"]= "0,3"  # Set the GPU 0 to use
...
def run():
    ...
    wandb.run.name = str("sigmoid_RGB_mobilenetv2_") + str(args.arch) + "_" + str(cfg["lr"]) + "_" + str(cfg["batch_size"]) + "_" + str(cfg["imgsize"]) + "_" + str(cfg["num_class"]) 
    wandb.run.save()
    config = {"lr":cfg["lr"],"batch_size":cfg["batch_size"],"architecture" : model}
    wandb.init(config = config)
    wandb.watch(model,loss_fn,log="all",log_freq=10)

    train_data_path = r"/home/msl2024a/resize_idrid2_1024/original/train"
    test_data_path = r"/home/msl2024a/resize_idrid2_1024/original/test"

    Label_train_data_path = r"/home/msl2024a/resize_idrid2_1024/gt/train"
    Label_test_data_path = r"/home/msl2024a/resize_idrid2_1024/gt/test"
